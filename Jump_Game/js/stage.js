...
{x:1500, y:384, w:36, h:48, type:"jumper"},
...
{x:5400, y:528, w:48, h:48, type:"needle"}
  ...
  // --- Stage 2 ---
  {
    blocks: [
      ...
      {x:300, y:60, w:144, h:48, type:8},//氷の床
      ...
      {x:600, y:100, w:192, h:48, type:5},//落ちる床
      ...
      {x:1500, y:100, w:192, h:48, type:5},//落ちる床
      ...
      {x:2400, y:100, w:192, h:48, type:5},//落ちる床
...
{x:700, y:50, w:36, h:48, type:"heal"},
...
{x:5300, y:450, w:36, h:48, type:"jumper"}
  ...
  // --- Stage 3（ラスボス） ---
  {
    blocks: [
      ...
      {x:1968, y:480, w:480, h:48, type:1},//ノーマル床
      {x:2448, y:480, w:144, h:48, type:33},//海
      {x:2592, y:480, w:2500, h:48, type:1},//ノーマル床
      {x:5144, y:480, w:1000, h:48, type:33},//海
      //{x:3072, y:480, w:240, h:48, type:33},//海
      //{x:3312, y:480, w:720, h:48, type:1},//ノーマル床
      //{x:4032, y:480, w:96, h:48, type:33},//海
      //{x:4128, y:480, w:2000, h:48, type:1},//ノーマル床
      ...
      {x:4400, y:400, w:48, h:48, type:6},//上に飛ぶバネ
