...
export const LEVELS = [
  // --- Stage 1 ---
  {
    blocks: [
      ...
      {x:1484, y:480, w:96, h:48, type:33},//海
      {x:1574, y:480, w:48, h:48, type:33},//ノーマル床
      
      {x:1622, y:480, w:240, h:48, type:1},//ノーマル床
      {x:1862, y:480, w:96, h:48, type:33},//海
      {x:1960, y:480, w:480, h:48, type:1},//ノーマル床
      {x:2440, y:480, w:144, h:48, type:33},//海
      {x:2584, y:480, w:480, h:48, type:1},//ノーマル床
