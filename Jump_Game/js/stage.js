...
export const LEVELS = [
  // --- Stage 1 ---
  {
    blocks: [
      ...
      {x:450, y:200, w:48, h:48, type:59},
      {x:380, y:432, w:48, h:48, type:13},
      {x:430, y:432, w:48, h:48, type:14},
      {x:192, y:482, w:96, h:48, type:33},
      { x: 650, y: 300, w:48, h: 48, type:17},
      { x: 650, y: 335, w:48, h: 48, type:48},
      {x:604, y:432, w:48, h:48, type:20},
      {x:652, y:432, w:48, h:48, type:19},
      {x:700, y:432, w:48, h:48, type:18},
      {x:950, y:432, w:48, h:48, type:58},
      {x:840, y:432, w:48, h:48, type:54},
      {x:1050, y:432, w:48, h:48, type:34},
      {x:1350, y:232, w:48, h:48, type:55},
      {x:1450, y:432, w:48, h:48, type:22},
      {x:1150, y:432, w:48, h:48, type:38},
      {x:1200, y:432, w:48, h:48, type:43},
      {x:1200, y:384, w:48, h:48, type:44},
      {x:1250, y:432, w:48, h:48, type:22},
      ...
      {x:288, y:432, w:48, h:48, type:3},
      {x:288, y:480, w:2400, h:48, type:0},
      {x:500, y:380, w:192, h:48, type:1},
      {x:800, y:380, w:192, h:4, type:8},
      {x:800, y:180, w:192, h:48, type:4, startX:800, dir:1, speed:2, range:200},
      {x:1000, y:300, w:192, h:48, type:5},
      {x:1200, y:340, w:48, h:48,compress: 0 ,type:6},
      {x:1250, y:340, w:48, h:48,compress: 0 ,type:6},
      { x: 1700, y: 150, w:48, h:48,compress: 0 ,type:50},
      { x: 1800, y: 150, w:48, h:48,compress: 0 ,type:51},
      {x:1700, y:360, w:192, h:48, type:7, startY:360, dir:1, speed:1, range:80},
      {x:160, y:250, w:192, h:48, type:9},
      {x:630, y:150, w:96, h:48,type:11,centerX:600,centerY:250,radius:80,angle:0,angularSpeed:0.03},
      {x:1200, y:150, w:96, h:48,type:12,centerX:600,centerY:250,radius:80,angle:0,angularSpeed:0.03}
    ],
  ...
  // --- Stage 2 ---
  {
    ...
    enemies: [
      ...
      {x:400, y:366, w:36, h:48, dir:-1, speed:1},
      {x:950, y:266, w:36, h:48, dir:-1, speed:1},
  ...
  // --- Stage 3（ラスボス） ---
  {
    blocks: [
      {x:0, y:480, w:2400, h:48, type:0},
      {x:450, y:380, w:240, h:48, type:1},
      {x:700, y:260, w:192, h:48, type:5},
      {x:900, y:230, w:48, h:48, type:6},
      {x:1300, y:80, w:192, h:48, type:7, startY:160, dir:1, speed:1, range:100},
      {x:450, y:200, w:192, h:48, type:8},
      {x:300, y:250, w:192, h:48, type:9},
      {x:1100, y:100, w:96, h:48,type:11,centerX:600,centerY:250,radius:80,angle:0,angularSpeed:0.03}
    ],
enemies: [
  // ▼ 回復アイテム
